...
def main():
    parser = argparse.ArgumentParser(description="宠物打喷嚏/咳嗽检测工具")
    parser.add_argument("--input", help="本地宠物活动视频（含音频）文件路径")
    parser.add_argument("--url", help="网络宠物活动视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示打喷嚏/咳嗽检测历史报告清单")
