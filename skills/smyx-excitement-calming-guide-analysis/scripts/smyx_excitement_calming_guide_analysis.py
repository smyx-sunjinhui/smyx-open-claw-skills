...
def main():
    parser = argparse.ArgumentParser(description="宠物兴奋过度冷静引导工具")
    parser.add_argument("--input", help="本地宠物活动区域视频文件路径")
    parser.add_argument("--url", help="网络宠物活动区域视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示兴奋冷静引导历史报告清单")
