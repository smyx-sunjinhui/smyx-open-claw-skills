...
def main():
    parser = argparse.ArgumentParser(description="宠物紫外线消毒安全监测工具")
    parser.add_argument("--input", help="本地紫外线消毒区域视频文件路径")
    parser.add_argument("--url", help="网络紫外线消毒区域视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示紫外线消毒安全监测历史报告清单")
