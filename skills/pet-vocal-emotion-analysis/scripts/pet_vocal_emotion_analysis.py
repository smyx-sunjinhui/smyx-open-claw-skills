...
def main():
    parser = argparse.ArgumentParser(description="宠物叫声情绪解析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示宠物叫声情绪解析列表清单")
