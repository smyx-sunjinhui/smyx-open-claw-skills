...
class ConstantEnum(BaseEnum):
    ...
    class SceneCodeEnum(Enum):
        ...
        SMYX_CROP_PEST_IDENTIFICATION_ANALYSIS = "SMYX_CROP_PEST_IDENTIFICATION_ANALYSIS"
        SMYX_CROP_FRUIT_RIPENESS_GRADING_ANALYSIS = "SMYX_CROP_FRUIT_RIPENESS_GRADING_ANALYSIS"
        SMYX_FARMLAND_WEED_IDENTIFICATION_ANALYSIS = "SMYX_FARMLAND_WEED_IDENTIFICATION_ANALYSIS"
        SMYX_CROP_SPECIFIC_DISEASE_ANALYSIS = "SMYX_CROP_SPECIFIC_DISEASE_ANALYSIS"
        SMYX_CROP_YIELD_PREDICTION_ANALYSIS = "SMYX_CROP_YIELD_PREDICTION_ANALYSIS"
        SMYX_LIVESTOCK_INDIVIDUAL_ANALYSIS = "SMYX_LIVESTOCK_INDIVIDUAL_ANALYSIS"
        SMYX_FEED_DRINK_BEHAVIOR_MONITOR_ANALYSIS = "SMYX_FEED_DRINK_BEHAVIOR_MONITOR_ANALYSIS"
        SMYX_LIVESTOCK_FEVER_DETECTION_ANALYSIS = "SMYX_LIVESTOCK_FEVER_DETECTION_ANALYSIS"
        SMYX_SICK_POULTRY_BEHAVIOR_DETECT_ANALYSIS = "SMYX_SICK_POULTRY_BEHAVIOR_DETECT_ANALYSIS"
        SMYX_ESTRUS_MATING_BEHAVIOR_DETECT_ANALYSIS = "SMYX_ESTRUS_MATING_BEHAVIOR_DETECT_ANALYSIS"
        SMYX_FEED_INTAKE_ESTIMATION_ANALYSIS = "SMYX_FEED_INTAKE_ESTIMATION_ANALYSIS"
        SMYX_LIVESTOCK_COUNTING_ANALYSIS = "SMYX_LIVESTOCK_COUNTING_ANALYSIS"
        SMYX_AGGRESSIVE_BEHAVIOR_DETECTION_ANALYSIS = "SMYX_AGGRESSIVE_BEHAVIOR_DETECTION_ANALYSIS"
        SMYX_BODY_SIZE_WEIGHT_ESTIMATION_ANALYSIS = "SMYX_BODY_SIZE_WEIGHT_ESTIMATION_ANALYSIS"
        SMYX_FARROWING_HATCHING_MONITORING_ANALYSIS = "SMYX_FARROWING_HATCHING_MONITORING_ANALYSIS"
        SMYX_VOCALIZATION_HEALTH_ANALYSIS_ANALYSIS = "SMYX_VOCALIZATION_HEALTH_ANALYSIS_ANALYSIS"
        SMYX_ENVIRONMENTAL_ANOMALY_ANALYSIS = "SMYX_ENVIRONMENTAL_ANOMALY_ANALYSIS"
