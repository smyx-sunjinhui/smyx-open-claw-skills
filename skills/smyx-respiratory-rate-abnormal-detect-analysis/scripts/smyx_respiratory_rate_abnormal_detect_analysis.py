...
def main():
    parser = argparse.ArgumentParser(description="宠物呼吸频率异常监测（静息）工具")
    parser.add_argument("--input", help="本地宠物静息状态视频文件路径")
    parser.add_argument("--url", help="网络宠物静息状态视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示呼吸频率异常监测历史报告清单")
