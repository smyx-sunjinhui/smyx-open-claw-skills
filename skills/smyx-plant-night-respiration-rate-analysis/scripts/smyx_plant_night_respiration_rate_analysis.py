...
def main():
    parser = argparse.ArgumentParser(description="植物夜间呼吸作用强度估算工具")
    parser.add_argument("--input", help="本地植物冠层夜间热成像图像/视频文件路径")
    parser.add_argument("--url", help="网络植物冠层夜间热成像图像/视频的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示植物夜间呼吸强度分析列表清单")
