...
def main():
    parser = argparse.ArgumentParser(description="宠物猫抓板使用频率与强度分析工具")
    parser.add_argument("--input", help="本地猫抓板视频文件路径")
    parser.add_argument("--url", help="网络猫抓板视频MP4的URL地址")
