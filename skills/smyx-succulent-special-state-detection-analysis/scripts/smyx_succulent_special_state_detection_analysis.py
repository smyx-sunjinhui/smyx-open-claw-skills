...
def main():
    parser = argparse.ArgumentParser(description="多肉植物特殊状态识别工具")
    parser.add_argument("--input", help="本地多肉植物图像或视频文件路径")
    parser.add_argument("--url", help="网络多肉植物图像或视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示多肉特殊状态识别历史报告清单")
