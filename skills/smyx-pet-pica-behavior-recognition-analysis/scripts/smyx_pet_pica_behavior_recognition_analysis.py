...
def main():
    parser = argparse.ArgumentParser(description="宠物异食行为识别工具（啃咬电线/塑料）")
    parser.add_argument("--input", help="本地室内监控视频文件路径")
    parser.add_argument("--url", help="网络室内监控视频MP4的URL地址")
    ...
    try:
        ...
        print("🔍 正在分析宠物异食行为（啃咬电线/塑料等非食物物品），请稍候...")
