...
def main():
    parser = argparse.ArgumentParser(description="宠物赛跑/竞赛作弊识别（起跑/窜道）工具")
    parser.add_argument("--input", help="本地赛道起点/终点视频文件路径")
    parser.add_argument("--url", help="网络赛道起点/终点视频MP4的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示竞赛犯规检测历史报告列表清单")
    ...
    try:
        ...
        print("🔍 正在分析赛道视频，检测抢跑/窜道犯规行为，请稍候...")
