...
def main():
    parser = argparse.ArgumentParser(description="儿童户外活动时长监测工具")
    parser.add_argument("--input", help="本地阳台门/入户门口固定摄像头视频文件路径")
    ...
    try:
        ...
        print("🔍 正在统计儿童进出家门/阳台事件并累计当日户外活动总时长，请稍候...")
