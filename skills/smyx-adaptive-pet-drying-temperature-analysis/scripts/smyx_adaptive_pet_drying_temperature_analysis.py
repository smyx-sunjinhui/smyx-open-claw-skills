...
def main():
    parser = argparse.ArgumentParser(description="宠物烘干温度自适应推荐工具")
    parser.add_argument("--input", help="本地宠物全身图像/视频文件路径（多角度最佳）")
    parser.add_argument("--url", help="网络宠物全身图像/视频URL地址（多角度最佳）")
    ...
    try:
        ...
        print("🔍 正在识别宠物品种与毛发密度，生成烘干温度推荐曲线，请稍候...")
