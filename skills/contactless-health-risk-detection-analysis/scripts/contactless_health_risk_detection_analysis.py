...
def detect_risk(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="非接触式健康风险识别分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示非接触健康风险识别分析列表清单")
