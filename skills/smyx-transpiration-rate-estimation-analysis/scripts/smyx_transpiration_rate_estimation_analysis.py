...
def main():
    parser = argparse.ArgumentParser(description="室内绿植蒸腾速率估算工具")
    parser.add_argument("--input", help="本地叶片热成像/RGB 图像或视频文件路径")
    parser.add_argument("--url", help="网络叶片图像/视频的URL地址")
