...
def main():
    parser = argparse.ArgumentParser(description="宠物睡眠质量分析（时长/翻滚次数）工具")
    parser.add_argument("--input", help="本地宠物窝/休息区夜间视频文件路径")
    parser.add_argument("--url", help="网络宠物窝/休息区夜间视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示睡眠质量分析历史报告清单")
