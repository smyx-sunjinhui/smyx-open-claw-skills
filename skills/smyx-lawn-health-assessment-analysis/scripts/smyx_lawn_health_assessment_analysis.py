...
def main():
    parser = argparse.ArgumentParser(description="草坪枯黄率与杂草密度评估工具")
    parser.add_argument("--input", help="本地草坪俯视图像/视频文件路径")
    parser.add_argument("--url", help="网络草坪俯视图像/视频的URL地址")
    parser.add_argument("--pet-type", choices=["cat", "dog", "other"], default=ConstantEnum.DEFAULT__PET_TYPE,
                        help="类别标识：草坪场景默认 other")
