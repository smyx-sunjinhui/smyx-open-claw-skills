...
def main():
    parser = argparse.ArgumentParser(description="植物叶片病害特征识别工具")
    parser.add_argument("--input", help="本地植物叶片高清图像或视频文件路径")
    parser.add_argument("--url", help="网络植物叶片图像或视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示植物病害识别历史报告清单")
