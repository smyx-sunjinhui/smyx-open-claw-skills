...
def recognize_disease(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="植物病害识别分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示植物病害识别分析列表清单")
    ...
    try:
        ...
        print("🔍 正在识别植物病害，请稍候...")
        output_content = recognize_disease(
