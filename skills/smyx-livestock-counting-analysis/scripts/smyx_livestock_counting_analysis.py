...
def main():
    parser = argparse.ArgumentParser(description="养殖场盘点计数工具")
    parser.add_argument("--input", help="本地畜禽舍/通道图像/视频文件路径")
    parser.add_argument("--url", help="网络畜禽舍/通道图像/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示养殖场盘点计数历史报告清单")
