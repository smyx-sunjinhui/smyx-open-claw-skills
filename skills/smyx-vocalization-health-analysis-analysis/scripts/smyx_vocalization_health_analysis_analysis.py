...
def main():
    parser = argparse.ArgumentParser(description="畜禽声纹健康分析工具")
    parser.add_argument("--input", help="本地畜禽叫声音频/视频文件路径")
    parser.add_argument("--url", help="网络畜禽叫声音频/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示畜禽声纹健康分析历史报告清单")
