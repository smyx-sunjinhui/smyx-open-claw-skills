...
def main():
    parser = argparse.ArgumentParser(description="农田杂草识别与密度评估工具")
    parser.add_argument("--input", help="本地田间图像/视频文件路径")
    parser.add_argument("--url", help="网络田间图像/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示农田杂草识别分析历史报告清单")
