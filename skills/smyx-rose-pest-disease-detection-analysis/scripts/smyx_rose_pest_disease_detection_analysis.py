...
def main():
    parser = argparse.ArgumentParser(description="月季/玫瑰常见病虫害识别工具")
    parser.add_argument("--input", help="本地月季/玫瑰图像/视频文件路径")
    parser.add_argument("--url", help="网络月季/玫瑰图像/视频的URL地址")
    parser.add_argument("--pet-type", choices=["cat", "dog", "other"], default=ConstantEnum.DEFAULT__PET_TYPE,
                        help="类别标识：花卉场景默认 other")
