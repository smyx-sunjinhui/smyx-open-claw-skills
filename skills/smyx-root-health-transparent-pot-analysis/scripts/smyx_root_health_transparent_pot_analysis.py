...
def main():
    parser = argparse.ArgumentParser(description="植物根系健康（透明盆）分析工具")
    parser.add_argument("--input", help="本地根系图像/视频文件路径")
    parser.add_argument("--url", help="网络根系图像/视频的URL地址")
