...
def monitor_wilting(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="植物枯萎监测分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示植物枯萎监测分析列表清单")
    ...
    try:
        ...
        print("🔍 正在监测植物早期枯萎状况，请稍候...")
        output_content = monitor_wilting(
