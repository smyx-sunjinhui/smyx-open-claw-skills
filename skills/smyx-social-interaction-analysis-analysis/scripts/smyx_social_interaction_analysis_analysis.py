...
def main():
    parser = argparse.ArgumentParser(description="宠物社交行为分析（与其他宠物互动）工具")
    parser.add_argument("--input", help="本地多宠互动视频文件路径")
    parser.add_argument("--url", help="网络多宠互动视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示社交行为分析历史报告清单")
