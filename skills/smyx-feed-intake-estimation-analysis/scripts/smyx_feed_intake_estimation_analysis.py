...
def main():
    parser = argparse.ArgumentParser(description="畜禽采食量估算工具")
    parser.add_argument("--input", help="本地食槽区域图像/视频文件路径")
    parser.add_argument("--url", help="网络食槽区域图像/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示畜禽采食量估算历史报告清单")
