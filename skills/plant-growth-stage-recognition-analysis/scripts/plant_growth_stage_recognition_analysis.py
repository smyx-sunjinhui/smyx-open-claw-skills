...
def recognize_plant(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="植物生长阶段识别分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示植物生长阶段识别分析列表清单")
    ...
    try:
        ...
        print("🔍 正在识别植物生长阶段，请稍候...")
        output_content = recognize_plant(
