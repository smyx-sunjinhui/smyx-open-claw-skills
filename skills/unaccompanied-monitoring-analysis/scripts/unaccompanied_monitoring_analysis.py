...
def monitor_unaccompanied(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="无人陪伴监测分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示无人陪伴监测分析列表清单")
    ...
    try:
        ...
        print("🔍 正在监测无人陪伴情况，请稍候...")
        output_content = monitor_unaccompanied(
