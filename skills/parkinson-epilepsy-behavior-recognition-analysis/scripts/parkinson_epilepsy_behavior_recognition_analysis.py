...
def recognize_behavior(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="帕金森癫痫行为识别分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示帕金森癫痫行为识别分析列表清单")
    ...
    try:
        ...
        print("🔍 正在识别异常行为，请稍候...")
        output_content = recognize_behavior(
