...
def monitor_kick(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="婴儿蹬被监测分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示婴儿蹬被监测分析列表清单")
    ...
    try:
        ...
        print("🔍 正在监测婴儿蹬被行为，请稍候...")
        output_content = monitor_kick(
