...
def main():
    parser = argparse.ArgumentParser(description="儿童接触危险物品识别工具")
    parser.add_argument("--input", help="本地儿童活动区域监控视频文件路径")
    parser.add_argument("--url", help="网络儿童活动区域监控视频的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示儿童接触危险物品识别分析列表清单")
