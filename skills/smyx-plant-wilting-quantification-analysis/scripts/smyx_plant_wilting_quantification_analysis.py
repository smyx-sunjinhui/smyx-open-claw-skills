...
def main():
    parser = argparse.ArgumentParser(description="植物萎蔫程度量化（缺水/水多）工具")
    parser.add_argument("--input", help="本地植物整体图像或视频文件路径")
    parser.add_argument("--url", help="网络植物整体图像或视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示植物萎蔫量化历史报告清单")
