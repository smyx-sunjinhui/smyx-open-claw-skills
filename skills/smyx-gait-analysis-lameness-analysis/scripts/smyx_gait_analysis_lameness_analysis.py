...
def main():
    parser = argparse.ArgumentParser(description="宠物步态分析（跛行/关节炎）工具")
    parser.add_argument("--input", help="本地宠物侧面行走视频文件路径")
    parser.add_argument("--url", help="网络宠物侧面行走视频MP4的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示步态分析历史报告列表清单")
