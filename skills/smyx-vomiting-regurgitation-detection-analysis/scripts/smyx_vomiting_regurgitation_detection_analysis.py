...
def main():
    parser = argparse.ArgumentParser(description="宠物呕吐/反流行为识别工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示呕吐/反流行为识别历史报告清单")
