...
def main():
    parser = argparse.ArgumentParser(description="宠物美容过程应激行为识别工具")
    parser.add_argument("--input", help="本地美容过程视频文件路径")
    parser.add_argument("--url", help="网络美容过程视频MP4的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示宠物美容应激历史分析列表清单")
