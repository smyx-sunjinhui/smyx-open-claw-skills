...
def main():
    parser = argparse.ArgumentParser(description="产仔/孵化监控工具")
    parser.add_argument("--input", help="本地产房/孵化区图像/视频文件路径")
    parser.add_argument("--url", help="网络产房/孵化区图像/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示产仔/孵化监控历史报告清单")
