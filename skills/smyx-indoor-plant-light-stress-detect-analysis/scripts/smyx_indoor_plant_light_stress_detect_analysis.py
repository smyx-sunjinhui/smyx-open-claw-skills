...
def main():
    parser = argparse.ArgumentParser(description="室内植物光照不足/过强识别工具")
    parser.add_argument("--input", help="本地植物图像/视频文件路径")
    parser.add_argument("--url", help="网络植物图像/视频的URL地址")
