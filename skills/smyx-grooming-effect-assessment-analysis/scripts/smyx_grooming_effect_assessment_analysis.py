...
def main():
    parser = argparse.ArgumentParser(description="宠物梳毛效果评估（毛结/皮屑）工具")
    parser.add_argument("--input", help="本地梳毛后宠物皮肤/毛发图像或视频文件路径")
    parser.add_argument("--url", help="网络梳毛后宠物皮肤/毛发图像或视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示梳毛效果评估历史报告清单")
