...
def main():
    parser = argparse.ArgumentParser(description="宠物烘干箱内热应激预警工具")
    parser.add_argument("--input", help="本地烘干箱视频文件路径")
    parser.add_argument("--url", help="网络烘干箱视频MP4的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示宠物热应激预警分析列表清单")
