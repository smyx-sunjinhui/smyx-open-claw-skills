...
def main():
    parser = argparse.ArgumentParser(description="宠物爬架/猫树活动热力图工具")
    parser.add_argument("--input", help="本地猫爬架视频文件路径")
    parser.add_argument("--url", help="网络猫爬架视频MP4的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示猫爬架活动热力图分析列表清单")
