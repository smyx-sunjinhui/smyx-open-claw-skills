...
def main():
    parser = argparse.ArgumentParser(description="宠物口腔抓拍与牙龈红肿识别工具")
    parser.add_argument("--input", help="本地宠物口腔抓拍图像/视频文件路径")
    parser.add_argument("--url", help="网络宠物口腔抓拍图像/视频URL地址")
