...
def main():
    parser = argparse.ArgumentParser(description="婴幼儿踢被/蹬被识别工具")
    parser.add_argument("--input", help="本地婴儿床夜间监控视频文件路径")
    parser.add_argument("--url", help="网络婴儿床夜间监控视频的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示婴幼儿踢被/蹬被识别分析列表清单")
