...
def main():
    parser = argparse.ArgumentParser(description="宠物猫砂盆使用频次与时长工具")
    parser.add_argument("--input", help="本地猫砂盆区域视频文件路径")
    parser.add_argument("--url", help="网络猫砂盆区域视频MP4的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示猫砂盆使用监测历史报告列表清单")
