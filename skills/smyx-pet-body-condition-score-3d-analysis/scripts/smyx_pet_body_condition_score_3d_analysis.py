...
def main():
    parser = argparse.ArgumentParser(description="宠物体态3D评分（BCS）分析工具")
    parser.add_argument("--input", help="本地宠物多角度视频文件路径（站立/侧身/俯视）")
    parser.add_argument("--url", help="网络宠物多角度视频MP4的URL地址")
