...
def main():
    parser = argparse.ArgumentParser(description="宠物猫砂盆排泄物性状识别工具")
    parser.add_argument("--input", help="本地猫砂盆视频文件路径")
    parser.add_argument("--url", help="网络猫砂盆视频MP4的URL地址")
