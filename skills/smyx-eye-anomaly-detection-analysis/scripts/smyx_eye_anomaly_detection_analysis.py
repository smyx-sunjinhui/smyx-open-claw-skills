...
def main():
    parser = argparse.ArgumentParser(description="宠物眼睛异常识别（红肿/流泪/白内障）工具")
    parser.add_argument("--input", help="本地宠物面部近景视频或图像文件路径")
    parser.add_argument("--url", help="网络宠物面部近景视频或图像URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示眼睛异常识别历史报告清单")
