...
def monitor_behavior(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="老人离床徘徊监测分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示老人离床徘徊监测分析列表清单")
    ...
    try:
        ...
        print("🔍 正在监测老人离床徘徊行为，请稍候...")
        output_content = monitor_behavior(
