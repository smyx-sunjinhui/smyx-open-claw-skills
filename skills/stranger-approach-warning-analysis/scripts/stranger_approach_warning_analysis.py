...
def analyze_approach(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="陌生人靠近预警分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示陌生人靠近预警分析列表清单")
    ...
    try:
        ...
        print("🔍 正在分析监控画面，请稍候...")
        output_content = analyze_approach(
