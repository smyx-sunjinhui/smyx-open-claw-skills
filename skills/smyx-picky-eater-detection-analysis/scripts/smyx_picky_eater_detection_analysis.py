...
def main():
    parser = argparse.ArgumentParser(description="宠物选择性拒食识别工具")
    parser.add_argument("--input", help="本地食盆区域视频文件路径")
    parser.add_argument("--url", help="网络食盆区域视频MP4的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示宠物选择性拒食识别历史报告列表清单")
