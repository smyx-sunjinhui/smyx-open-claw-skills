...
def main():
    parser = argparse.ArgumentParser(description="畜禽个体识别与追踪工具")
    parser.add_argument("--input", help="本地畜禽面部/体表图像/视频文件路径")
    parser.add_argument("--url", help="网络畜禽面部/体表图像/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示畜禽个体识别历史报告清单")
