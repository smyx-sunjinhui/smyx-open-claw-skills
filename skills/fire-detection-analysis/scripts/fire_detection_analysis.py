...
def detect_fire(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="火情烟雾检测分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示火情检测分析列表清单")
