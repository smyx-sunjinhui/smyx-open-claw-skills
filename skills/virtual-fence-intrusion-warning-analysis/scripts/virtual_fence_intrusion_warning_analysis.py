...
def detect_intrusion(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="虚拟围栏越界预警分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示虚拟围栏越界预警分析列表清单")
    ...
    try:
        ...
        print("🔍 正在检测越界入侵，请稍候...")
        output_content = detect_intrusion(
