...
def main():
    parser = argparse.ArgumentParser(description="植物生长阶段自动判定工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示植物生长阶段判定历史报告清单")
