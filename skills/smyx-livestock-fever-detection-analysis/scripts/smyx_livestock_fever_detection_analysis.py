...
def main():
    parser = argparse.ArgumentParser(description="畜禽体温异常检测工具")
    parser.add_argument("--input", help="本地畜禽热成像/可见光图像/视频文件路径")
    parser.add_argument("--url", help="网络畜禽热成像/可见光图像/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示畜禽体温异常检测历史报告清单")
