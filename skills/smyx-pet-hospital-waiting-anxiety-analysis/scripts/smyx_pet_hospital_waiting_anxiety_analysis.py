...
def main():
    parser = argparse.ArgumentParser(description="宠物医院候诊焦虑等级评估工具")
    parser.add_argument("--input", help="本地候诊区宠物视频文件路径")
    parser.add_argument("--url", help="网络候诊区宠物视频MP4的URL地址")
