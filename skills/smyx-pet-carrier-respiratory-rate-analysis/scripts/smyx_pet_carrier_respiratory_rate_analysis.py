...
def main():
    parser = argparse.ArgumentParser(description="宠物航空箱内呼吸频率监测工具")
    parser.add_argument("--input", help="本地航空箱内宠物视频文件路径")
    parser.add_argument("--url", help="网络航空箱内宠物视频MP4的URL地址")
