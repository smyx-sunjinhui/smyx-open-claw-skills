...
def main():
    parser = argparse.ArgumentParser(description="经济作物产量预测工具")
    parser.add_argument("--input", help="本地作物植株/田块图像/视频文件路径")
    parser.add_argument("--url", help="网络作物植株/田块图像/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示经济作物产量预测历史报告清单")
