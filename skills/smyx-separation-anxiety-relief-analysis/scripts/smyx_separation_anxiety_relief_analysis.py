...
def main():
    parser = argparse.ArgumentParser(description="宠物分离焦虑舒缓（主人离家时）工具")
    parser.add_argument("--input", help="本地宠物独处状态视频文件路径")
    parser.add_argument("--url", help="网络宠物独处状态视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示分离焦虑监测历史报告清单")
