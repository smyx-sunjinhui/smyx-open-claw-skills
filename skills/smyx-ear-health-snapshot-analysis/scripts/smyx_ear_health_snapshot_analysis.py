...
def main():
    parser = argparse.ArgumentParser(description="宠物耳道健康抓拍与红肿识别工具")
    parser.add_argument("--input", help="本地宠物耳道/甩耳挠耳视频文件路径")
    parser.add_argument("--url", help="网络宠物耳道/甩耳挠耳视频MP4的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示耳道健康分析历史报告列表清单")
    ...
    try:
        ...
        print("🔍 正在分析宠物耳道健康（甩耳/挠耳触发的耳道抓拍图像），请稍候...")
