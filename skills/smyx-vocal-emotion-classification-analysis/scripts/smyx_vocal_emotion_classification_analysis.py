...
def main():
    parser = argparse.ArgumentParser(description="宠物叫声情绪深度分类工具")
    parser.add_argument("--input", help="本地宠物叫声音频/视频文件路径")
    parser.add_argument("--url", help="网络宠物叫声音频/视频MP4/MP3的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示叫声情绪分类历史报告列表清单")
