...
def main():
    parser = argparse.ArgumentParser(description="畜禽发情/配种行为识别工具")
    parser.add_argument("--input", help="本地母畜舍图像/视频文件路径")
    parser.add_argument("--url", help="网络母畜舍图像/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示畜禽发情/配种行为识别历史报告清单")
