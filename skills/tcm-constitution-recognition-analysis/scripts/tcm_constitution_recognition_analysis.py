...
def analyze_constitution(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="中医体质识别分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示中医体质识别分析列表清单")
    ...
    try:
        ...
        print("🔍 正在识别中医体质，请稍候...")
        output_content = analyze_constitution(
