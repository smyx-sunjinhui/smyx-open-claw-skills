...
def main():
    parser = argparse.ArgumentParser(description="畜禽采食/饮水行为监测工具")
    parser.add_argument("--input", help="本地食槽/饮水区域图像/视频文件路径")
    parser.add_argument("--url", help="网络食槽/饮水区域图像/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示畜禽采食/饮水行为监测历史报告清单")
