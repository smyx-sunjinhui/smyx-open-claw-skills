...
def analyze_fall(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="跌倒检测分析工具（图片/视频版）")
    ...
    parser.add_argument("--list", action='store_true', help="显示跌倒检测分析列表清单")
