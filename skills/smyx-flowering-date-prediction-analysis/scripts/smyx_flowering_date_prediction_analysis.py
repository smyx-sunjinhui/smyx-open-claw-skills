...
def main():
    parser = argparse.ArgumentParser(description="开花植物花期预测工具")
    parser.add_argument("--input", help="本地花蕾图像/视频文件路径")
    parser.add_argument("--url", help="网络花蕾图像/视频的URL地址")
