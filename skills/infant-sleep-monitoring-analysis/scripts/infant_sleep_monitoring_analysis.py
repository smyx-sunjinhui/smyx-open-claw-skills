...
def monitor_sleep(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="婴儿睡眠状态监测分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示婴儿睡眠监测分析列表清单")
    ...
    try:
        ...
        print("🔍 正在分析婴儿睡眠状态，请稍候...")
        output_content = monitor_sleep(
