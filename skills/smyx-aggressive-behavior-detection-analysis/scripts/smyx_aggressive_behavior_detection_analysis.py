...
def main():
    parser = argparse.ArgumentParser(description="畜禽争斗行为识别工具")
    parser.add_argument("--input", help="本地畜禽舍图像/视频文件路径")
    parser.add_argument("--url", help="网络畜禽舍图像/视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示畜禽争斗行为识别历史报告清单")
