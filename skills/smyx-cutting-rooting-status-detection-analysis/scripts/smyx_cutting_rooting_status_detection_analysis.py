...
def main():
    parser = argparse.ArgumentParser(description="扦插枝条生根状态（透明容器）分析工具")
    parser.add_argument("--input", help="本地扦插枝条基部图像/视频文件路径")
    parser.add_argument("--url", help="网络扦插图像/视频的URL地址")
