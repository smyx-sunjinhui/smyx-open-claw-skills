...
def main():
    parser = argparse.ArgumentParser(description="宠物排便形态识别工具（狗厕所/户外）")
    parser.add_argument("--input", help="本地狗厕所/户外排便区域视频或图片文件路径")
    parser.add_argument("--url", help="网络狗厕所/户外排便区域视频或图片URL地址")
