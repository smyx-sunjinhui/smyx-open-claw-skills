...
def main():
    parser = argparse.ArgumentParser(description="宠物训练指令执行识别工具（坐/卧/等）")
    parser.add_argument("--input", help="本地训练区域视频文件路径")
    parser.add_argument("--url", help="网络训练区域视频MP4的URL地址")
    ...
    try:
        ...
        print("🔍 正在分析宠物训练指令执行情况（坐/卧/等），请稍候...")
