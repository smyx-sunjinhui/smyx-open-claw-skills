...
def main():
    parser = argparse.ArgumentParser(description="宠物饮水机饮水量精准记录工具")
    parser.add_argument("--input", help="本地饮水机视频文件路径")
    parser.add_argument("--url", help="网络饮水机视频MP4的URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示宠物饮水量历史分析列表清单")
