...
def main():
    parser = argparse.ArgumentParser(description="番茄/辣椒开花坐果率分析工具")
    parser.add_argument("--input", help="本地花果区域图像/视频文件路径")
    parser.add_argument("--url", help="网络花果区域图像/视频的URL地址")
    parser.add_argument("--pet-type", choices=["cat", "dog", "other"], default=ConstantEnum.DEFAULT__PET_TYPE,
                        help="类别标识：蔬果场景默认 other")
