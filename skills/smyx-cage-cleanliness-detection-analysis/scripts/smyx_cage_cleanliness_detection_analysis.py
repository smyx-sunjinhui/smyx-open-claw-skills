...
def main():
    parser = argparse.ArgumentParser(description="宠物寄养笼舍清洁度识别工具")
    parser.add_argument("--input", help="本地笼舍地面图像或视频文件路径")
    parser.add_argument("--url", help="网络笼舍地面图像或视频URL地址")
    ...
    parser.add_argument("--list", action='store_true', help="显示笼舍清洁度识别历史报告清单")
