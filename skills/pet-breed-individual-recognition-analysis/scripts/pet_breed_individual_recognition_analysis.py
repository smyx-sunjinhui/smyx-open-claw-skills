...
def recognize_pet(input_path=None, url=None, api_url=None, api_key=None, output_level=None):
...
def main():
    parser = argparse.ArgumentParser(description="宠物品种个体识别分析工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示宠物品种个体识别分析列表清单")
